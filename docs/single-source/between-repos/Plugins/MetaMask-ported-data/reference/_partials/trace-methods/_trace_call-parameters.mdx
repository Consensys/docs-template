- `transaction call object` _[Required]_ with the following keys and their values:
  ...
  - `maxPriorityFeePerGas`: _[optional]_ Maximum fee, in wei, the sender is willing to pay per gas above the base fee.
    See [EIP-1559 transactions](https://docs.metamask.io/services/concepts/transaction-types.md#eip-1559-transactions).
...
- `options`: A list of tracing options. Tracing options are [`trace`](https://docs.metamask.io/services/ethereum/json-rpc-methods/trace-methods/index.md#trace) and [`stateDiff`](https://docs.metamask.io/services/ethereum/json-rpc-methods/trace-methods/index.md#statediff).

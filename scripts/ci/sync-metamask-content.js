...
const SYNC_CONFIG = [
  {
    ...
    targetPath: "docs/single-source/between-repos/example-ported-data/services-index.md",
    description: "Services index page",
  },
  {
    sourcePath: "services/reference/base/json-rpc-methods",
    targetPath: "docs/single-source/between-repos/example-ported-data/reference/base/json-rpc-methods",

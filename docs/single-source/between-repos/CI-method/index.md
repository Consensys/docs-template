...
> **Note:** This is an alternative, untested approach. The partially-tested method is the Plugins approach.
...
This approach is archived/paused. See the Plugins method for the active implementation.
